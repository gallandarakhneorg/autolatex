...
svg, Gnuplot...) into a PDF or PNG file.
...
A plugin for the editor Sublime Text 2 <http://www.sublimetext.com/2> is provided. You could launch AutoLaTeX through the building tools of Sublime Text.  It is now considered as I<obsolete>, even still maintained. See the use of LaTeXTools in Sublime Text.
...
Copyright (c) 1998-2014  Stephane GALLAND <galland@arakhne.org>
...
Copyright (c)  1998-2014  Stephane Galland E<lt>galland@arakhne.orgE<gt>.
