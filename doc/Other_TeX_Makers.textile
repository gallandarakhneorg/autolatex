...
|<. "AutoLaTeX":http://www.ctan.org/pkg/autolatex |=. Perl/Python |=. 2014 |=. latex, pdflatex, xelatex, lualatex, bibtex, biber, makeindex, dvips |=. X |=. X |=. X |=. asta, dia, dot, fig, ggb, gxl, odg, plot, svg, vsdx, xmi |=. c/c++, java, matlab, ml, perl, python, ruby, sql, svg layers |=. fig, plot, dia, svg, svg layers |=. X |=. Gedit3, Gtk3, Sublime Text 3 (see "LaTeXTools plugin":https://github.com/SublimeText/LaTeXTools). Deprecated: Gedit2, Sublime Text 2, Gtk2 |
...
|<. "latexmk":http://www.ctan.org/pkg/latexmk/ |=. Perl |=. 2012 |=. latex, dvips, dvipdf, xelatex, pdflatex, bibtex, makeindex |=. X |=. X |=. X |=.  |=.  |=.  |=.  |=.  |
