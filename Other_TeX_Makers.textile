...
* _Export to Elsevier:_ Elsevier is a scientific publisher who permits to upload TeX white-papers for publication. After uploading the source files, the Elsevier website is running TeX on it, and give a compilation feedback. To avoid to much problems during this online compilation, I recommend:
...
*_ This column indicates if the tools is able to create a version of the document that is fitting these recommendations.
