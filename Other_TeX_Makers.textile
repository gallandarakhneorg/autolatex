...
|<. "AutoLaTeX":http://www.ctan.org/pkg/autolatex |=. Perl |=. 2013 |=. latex, pdflatex, xelatex, lualatex, bibtex, biber, makeindex, dvips |=. X |=. X |=. X |=. asta, dia, dot, fig, gxl, odg, plot, svg, xmi |=. c/c++, java, matlab, ml, perl, python, ruby, sql, svg layers |=. fig, plot, dia, svg, svg layers |=. X |=. Gedit (official), Sublime Text, Gtk (obsolete) |
