...
|<. "AutoLaTeX":http://www.ctan.org/pkg/autolatex |=. Perl |=. 2013 |=. latex, pdflatex, xelatex, lualatex, bibtex, makeindex, dvips |=. X |=. X |=. X |=. asta, dia, dot, fig, gxl, odg, plot, svg, xmi |=. c/c++, java, matlab, ml, perl, python, ruby, sql |=. fig, plot |=. X |=. X |
