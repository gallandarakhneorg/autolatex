...
=item I<set latex_draft_flags> : DEPRECATED.
...
=item I<set touch> : DEPRECATED.

=item I<set echo> : DEPRECATED.

=item I<set echo_err> : DEPRECATED.

=item I<set find> : DEPRECATED.
